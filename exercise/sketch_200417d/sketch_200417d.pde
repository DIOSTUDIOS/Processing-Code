...
Recursively creates a series of circles that orbit each other to form abstract patterns.
Inspired by Barbara Almeida's Circles (openprocessing.org/sketch/211167)
...
class Planet {
  ...
  ArrayList<Planet> addSatellites(int planetCount) {
    ...
    color newColor = color(globalHue, 255, 255, 20);
